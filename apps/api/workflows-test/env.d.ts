...
//
// wrangler.jsonc declares AUTHORING_WORKFLOW and RESOLUTION_WORKFLOW, but
// this project has no `wrangler types` step — no
...
// This augments just the bindings workflows-test/*.test.ts actually
