  ...
  return <View style={{ gap: space(3) }}>
    ...
    <View style={{ flexDirection: "row" }}>
      {([
        ...
        <Mono {...role.line} color={side.winner ? colors.goldText : colors.mutedInk}>{side.label}</Mono>
        <Ritual bold size={displayScale.epithet} color={side.winner ? colors.goldText : colors.ink} style={{ textAlign: "center" }}>{side.points}</Ritual>
